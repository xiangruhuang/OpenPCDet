...
class KNNGrouper(GrouperTemplate):
    def __init__(self, runtime_cfg, model_cfg):
        super(KNNGrouper, self).__init__(
...
class RadiusGrouper(GrouperTemplate):
    def __init__(self, runtime_cfg, model_cfg):
        super(RadiusGrouper, self).__init__(
                                       runtime_cfg=runtime_cfg,
                                       model_cfg=model_cfg,
                                   )
    ...
    def __repr__(self):
        return f"RadiusGrouper(radius={self.radius}, max_ngbrs={self.max_num_neighbors}, sort={self.sort_by_dist})"

GROUPERS = {
    'KNNGrouper': KNNGrouper,
    'RadiusGrouper': RadiusGrouper,
}
